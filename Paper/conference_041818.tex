...
In diesem Kapitel werden die Merkmale einer kollaborativen Lernumgebung gesammelt. %Erweitert werden diese Funktionen mithilfe von allgemeinem Kritikpunkten an Lernumgebungen.
...
\paragraph{Audience Response System(ARS)} Das bereits genannte ARS ist ein System um in Vorlesungen simultan von allen Zuhörern Input einzuholen, beispielsweise um Fachfragen zu beantworten. Diese Fachfragen und die dazugehörigen Antwortmöglichkeiten müssen vorher vom Vortragenden formuliert und im System gespeichert worden sein. Um diese Fragen jederzeit schnell aufrufen zu können, ist ein Zuordnung zur jeweiligen Lehrveranstaltung nötig, möglicherweise in Form eines Katalogs. Es besteht die Möglichkeit, dass eine Person mehrere Kurse als Vortragender leitet oder die Rolle des Schülers annimmt und selbst an Kursen teilnimmt. Genauso kann ein Kurs mehrere wechselnde Lehrer haben.\\ In Seminaren oder ähnlichen Lehrveranstaltung, muss es möglich sein, die Rolle des Vortragenden für einen begrenzten Zeitraum zu übertragen. In dieser Zeit kann der neue Vortragende ebenfalls fachbezogene Fragen stellen und sich Feedback vom Publikum einholen. Die Annahme der Rolle geschieht nur während der Lehrveranstaltung. Die Formulierung der Fragen samt Antworten findet während der Vorbereitung des Vortrags statt. 
\paragraph{Arbeitsgruppen} Im Rahmen einer Lehrveranstaltung wurden Schüler in Gruppen eingeteilt. In diesen Gruppen sollen sie nun gemeinsam verschiedene Aufgaben lösen. Neben einer zufälligen Zuteilung, kann die Gruppenbildung auf der Lernplattform stattfinden, wo Schüler Gruppen eröffnen oder sich einer vorhandenen anschließen können. In \cite{dewiyanti2007students} befragte Biasutti Studierende zu ihren Eindrücken, nachdem diese in einer kollaborativen Lernumgebung asynchron eine Aufgabe bearbeiteten. Als Kritikpunkte wurde, neben ungleichmäßiger Beteiligung, die Organisation innerhalb der Gruppe genannt. Eine klare Aufgabenverteilung wurde als wünschenswert betrachtet. In \cite{paechter2010students} und \cite{casamayor2009intelligent} wird betont wie wichtig es sei, dass der Lehrer einerseits als kompetenter Ansprechpartner zur Verfügung steht und andererseits die Aktivitäten der Gruppe zum Teil überwacht. Casamayor et al. stellen den Ansatz vor, relevante Statistiken einer Gruppe aufzuzeichnen und bei bestimmten Ereignisse den Lehrer zu benachrichtigen \cite{casamayor2009intelligent}. 
\paragraph{Offenes Forum} In OPAL\footnote{https://bildungsportal.sachsen.de/opal/} können zu Lehrveranstaltungen offene Foren eröffnet werden. Der Lehrer kann durch einen Eintrag alle Schüler über neue Informationen in Kenntnis setzen. Schüler haben die Gelegenheit Fragen zur Veranstaltung oder zu Aufgaben zu stellen, welche von anderen Schülern oder vom Lehrer beantwortet werden kann.
\paragraph{Reviews} Enthält eine Lehrveranstaltung eine schriftliche Ausarbeitung, kann jedem Schüler die Arbeit eines anderen zur Bewertung zugewiesen. 
...
\subsection{oom}  
%Nachteile von oom: etabliert weil, aber fehlerhaft, da nur struktur, aber nicht verhalten, verhalten aber wichtig, deswegen ist oom ineffizient, konkrete beispiele supplier/customer statedependance multipleclassses, eventuell angewandt an kollab e-learning
So etabliert und verbreitet objektorientierte Programmierung auch sein mag, so hat sie dennoch ihre Grenzen. 
